...
BOOL zcloudDlg::OnInitDialog()
{
    ...
    m_httpAddr.SetWindowText(TEXT("can.zlgcloud.com"));
    m_httpPort.SetWindowText(TEXT("443"));
    m_mqttAddr.SetWindowText(TEXT("can.zlgcloud.com"));
    m_mqttPort.SetWindowText(TEXT("8143"));
    m_username.SetWindowText(TEXT("15201297129"));
    m_password.SetWindowText(TEXT("cidi1234"));
